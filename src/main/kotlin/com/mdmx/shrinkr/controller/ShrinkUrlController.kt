...
import com.mdmx.shrinkr.service.ShrinkUrlService
...
class ShrinkUrlController(
  val shrinkUrlService: ShrinkUrlService
) {
  ...
  fun shrinkUrl(@RequestBody reqEty: ShrinkUrlReqEty): ShrinkUrlRespEty {
    return shrinkUrlService.shrinkUrlViaHashids(reqEty)
  }
}
